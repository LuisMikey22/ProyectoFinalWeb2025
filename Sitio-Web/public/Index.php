    ...
    <body>
        <header>
            <?php 
                ...
                $newest = getNewArt();
                $bestSeller = getBestSellingArt();
                $seasonal = getSeasonalArt();
            ?>
        </header>
                ...
                <div class="new-art-item-container item-container">
                    <?php foreach($newArts as $newest) : ?>
                        <div class="card bg-base-100 shadow-sm art-item item">
                            <a href="<?=SRC_PATH?>/views/Product.html"><figure class="art-item-image-container">
        ...
        <section class="shipping-info-banner">
            <div class="info-banner-statement">
                <span class="star-review-icon">
                    <img src="images/starIcon.svg" alt="star-review-icon">
                </span>
            ...
            <div class="info-banner-statement">
                <span class="shipping-icon">
                    <img src="images/truckIcon.svg" alt="shipping-icon">
                </span>
            ...
            <div class="info-banner-statement">
                <span class="return-icon">
                    <img src="images/boxIcon.svg" alt="return-icon">
                </span>
